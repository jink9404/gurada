...
<link rel="stylesheet" href="./resources/style/style.css"
	type="text/css">
<link rel="stylesheet" href="./resources/style/jquery.bxslider.css"
	type="text/css">
...
<body>
	...
	<header class="header-section">
		<div class="container-fluid">
			<div class="inner-header">
				<div class="logo">
					<a href="./index.jsp"><img src="./resources/img/logo.png"
						alt=""></a>
				</div>
				<div class="header-right">
					<img src="./resources/img/icons/search.png" alt=""
						class="search-trigger"> <img
						src="./resources/img/icons/man.png" alt=""> <a href="#">
						<img src="./resources/img/icons/bag.png" alt=""> <span>2</span>
					</a>
				</div>
	...
	<section class="hero-slider">
		<div class="hero-items owl-carousel">
			<div class="single-slider-item set-bg"
				data-setbg="./resources/img/slider-1.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<h1>2019</h1>
			...
			<div class="single-slider-item set-bg"
				data-setbg="./resources/img/slider-2.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<h1>2019</h1>
			...
			<div class="single-slider-item set-bg"
				data-setbg="./resources/img/slider-3.jpg">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<h1>2019</h1>
	...
	<div class='video'>
		<video controls autoplay>
			<source src="./resources/img/media/kakaotalk_1580541213542.mp4"
				type="video/mp4">
		</video>
	</div>
	<!-- bxslider Begin -->
