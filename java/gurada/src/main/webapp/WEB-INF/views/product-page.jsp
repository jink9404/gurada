			...
			<div class="row">
				<div class="col-lg-6">
					<div class="product-content">
						...
						<p>상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품
							설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품 설명/상품
							설명/상품 설명/</p>
						<ul class="tags">
						...
						<div class="product-quantity">
							<table>
								<tr>
									<td width="255"></td>
									<td width="60"><select class="buybtn2">
											<option>옵션1</option>
											<option>옵션2</option>
											<option>옵션3</option>
									</select></td>
